...
sudo apt update
sudo apt install -y bat btop htop tree lm-sensors libnotify-bin vlc gnome-tweaks xclip make build-essential libssl-dev zlib1g-dev libbz2-dev libreadline-dev libsqlite3-dev libncursesw5-dev xz-utils tk-dev libxml2-dev libxmlsec1-dev libffi-dev liblzma-dev
